...
export const HeroSection = () => (
  <section className="border-b border-slate-200/80 py-20 md:py-28">
    <div className="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-[1.3fr_1fr] md:items-end">
      <div>
        <Reveal>
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-slate-950 md:text-5xl">{site.hero.heading}</h1>
          <p className="mt-6 max-w-2xl text-lg text-slate-600">{site.hero.subheading}</p>
        </Reveal>
        <Reveal delay={0.1}>
      ...
      <Reveal delay={0.15}>
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-card">
          <p className="text-sm text-slate-600">{site.hero.proof}</p>
