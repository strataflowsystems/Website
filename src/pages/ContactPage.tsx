...
export const ContactPage = () => {
  ...
  return (
    <>
      ...
      <Section title="Contact" headingLevel={1} intro="Tell us about your operational workflow goals and we will follow up with a recommended next step.">
        <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-card dark:border-slate-800 dark:bg-slate-900">
            ...
            <form
              ...
              onSubmit={() => trackEvent('contact_form_submit', { page: '/contact' })}
            >
