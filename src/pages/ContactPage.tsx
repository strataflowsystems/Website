      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
        <div className="space-y-6">
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-card">
            <h2 className="text-lg font-semibold text-slate-900">Microsoft Form</h2>
            <p className="mt-2 text-sm text-slate-600">Preferred intake for enterprise teams.</p>
            <iframe
              title="Strataflow contact form"
              src="https://forms.office.com/Pages/ResponsePage.aspx?id=placeholder"
              className="mt-4 h-[560px] w-full rounded-lg border border-slate-200"
              loading="lazy"
            />
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-card">
            <h2 className="text-lg font-semibold text-slate-900">Fallback form</h2>
            <p className="mt-2 text-sm text-slate-600">Connect this action URL to Formspree (or your preferred endpoint) for static form handling.</p>
        ...
        <aside className="space-y-4 rounded-xl border border-slate-200 bg-white p-6 shadow-card">
          <h2 className="text-lg font-semibold text-slate-900">Direct contact</h2>
          <p className="text-slate-600">Email: <a href="mailto:hello@strataflowsystems.com" className="text-accent-600 hover:text-accent-500">hello@strataflowsystems.com</a></p>
          <p className="text-slate-600">Calendar: <a href="#" className="text-accent-600 hover:text-accent-500">Book a discovery call</a></p>
          <div>
